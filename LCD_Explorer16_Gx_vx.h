...
void lcd_cmd(unsigned char cmd); // write command to lcd
void lcd_data(unsigned char data); // write data to lcd
void inic_pines_LCD(void);
void inic_timer_LCD(void);
void espera_LCD_ms(unsigned int n_LCDseg);
...
extern unsigned int milisegundos_LCD;
extern int scroll;
